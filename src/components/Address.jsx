...
const Address = () => {
  const chunkedArray = (bestRestaurants, 4);
    ...
    <>
      <div className='max-w-[1200px] mx-auto px-2'>
        ...
        <div class="flex flex-wrap -m-2">
        {
          ...
          <div class="p-2 lg:w-1/4 md:w-1/2 w-full"  key={index}>
            <div class="h-full flex  items-center border-gray-200 border p-4 rounded-lg">
              <div class="flex-grow text-center">
                    <h2 class="text-gray-900 title-font font-medium">{item}</h2>
              </div>
            </div>
          </div>
          ))}
      ...
      <div className='max-w-[1200px] mx-auto px-2'>
        ...
        <div className='flex items-center justify-between my-5'>
          <div className='text-[25px] font-bold'>Explore Restaurants Near Me</div>
        </div>
        <div class="flex flex-wrap -m-2">
        {
          restaurantHeaders.map((item, index) => (
          <div class="p-2 lg:w-1/2 md:w-1/2 w-full"  key={index}>
            <div class="h-full flex  items-center border-gray-200 border p-4 rounded-lg">
              <div class="flex-grow text-center">
                    <h2 class="text-gray-900 title-font font-medium">{item}</h2>
              </div>
      ...
      <div class="container-fuild px-5 py-5 mx-auto flex items-center  flex-col md:flex-row  bg-gray-100">
        <div class="flex flex-col mx-auto items-center justify-center md:pr-10 md:mb-0 mb-6 pr-0 w-full md:w-auto text-center md:text-left">
          <div class=" flex space-x-40 text-[25px] font-bold  ">
            For better experience, download<br /> the Swiggy app now
            <div class="flex md:ml-auto md:mr-0 mx-auto items-center flex-shrink-0 space-x-4 ">
              <button class="bg-black text-white inline-flex py-3 px-5 rounded-lg items-center focus:outline-none">
              ...
              <button class="bg-black inline-flex  text-white py-3 px-5 rounded-lg items-center  focus:outline-none">
